...
# Intro.........................................................................line 40
# 1 Fish variables..............................................................line 60
# 1.1 General results - fish....................................................line 124
# 1.2 General results - otolith signatures......................................line 162
# 1.3 Estimating the size of the individual based on the laser transect.........line 174
# 1.4 Add the estimated TL......................................................line 240

# 2 Ba - GAMM otolith transect..................................................line 255
# 2.1 Ba - Plot - GAMM otolith transect.........................................line 304
# 2.2 Predict fish TL based on transect.........................................line 382

# 3 Ba - GAMM estimated TL......................................................line 416

# 4 Mg - GAMM...................................................................line 500
# 4.1 Mg - Plot.................................................................line 537

# 5 All elements................................................................line 577

# 6 Water chemistry.............................................................line 660
...
otolith <- otolith[, c("ID","Month","Year","Season","Ontogeny","Site","TL","Weight","Elapsed_Time","Mg24","Ba138")]
...
# ---- GAMM (Gamma; random intercept for Month and ID)
# Full model
...
plot(gamm_Ba_estimated_TL, pages = 1, shade = TRUE)
...
ggplot(newdat_Ba, aes(x = estimated_TL, y = fit)) +
  geom_line(color = "blue") +
  geom_ribbon(aes(ymin = fit - 2*se, ymax = fit + 2*se), alpha = 0.10, fill = "blue") +
  labs(y = expression("Predicted Ba:Ca ("*mu*"mol "*mol^{-1}*")"), x = expression(Distance~from~core~(mu*m))) + 
  theme_bw()
...
#scale
newdat_Mg$fit_scaled <- (newdat_Mg$fit - 200) / (450 - 200) * 9
newdat_Mg$se_scaled  <- newdat_Mg$se / (450 - 200) * 9
...
geom_ribbon(data = newdat_Mg,
            aes(x = estimated_TL,
                ymin = fit_scaled - 2*se_scaled,
                ymax = fit_scaled + 2*se_scaled,
                fill = "Mg:Ca"),
            alpha = 0.15) +
  ...
  scale_color_manual(
    name = " ",
    breaks = c("Ba:Ca", "Mg:Ca"),
    values = c("Ba:Ca" = "#40BBD2",
               "Mg:Ca" = "#4DAF4A")) +
  ...
  scale_y_continuous(
    limits = c(0, 9),
    breaks = seq(0, 9, 1),
    name = expression(Ba:Ca[otolith]~"(" * mu * mol~mol^{-1} * ")"),
    
    sec.axis = sec_axis(
      ~ . * (450 - 200) / 9 + 200,
      breaks = seq(200, 450, 50),
      name = expression(Mg:Ca[otolith]~"(" * mu * mol~mol^{-1} * ")"))) +
